        ...
        <div class="row border-top border-light mx-xl-5 py-4">
            <div class="col-md-10 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-dark">
                    &copy;
                    <a class="text-dark font-weight-semi-bold" href="#">Basel Kaffoura</a>. All Rights Reserved. Designed by
                    <a class="text-dark font-weight-semi-bold" href="#">Basel Kaffoura</a>
                </p>
            </div>
