...
<footer class="footer">
    <div class="d-sm-flex justify-content-center justify-content-sm-between">
        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <a href="https://omarkadish.wordpress.com/" target="_blank">Basel Kaffoura</a> 2019 - {{ date("Y") }}</span>
    </div>
</footer>
<!-- partial -->
