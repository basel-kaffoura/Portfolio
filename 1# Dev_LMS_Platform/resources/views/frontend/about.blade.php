                ...
                <div class="ourinstructor__wrapper mt-lg-5 mt-0">
                    <div class="ourinstructor-active">
                        ...
                        <div class="mentor">
                            ...
                            <div class="mentor__title">
                                <h6>
                                    <a href="instructor-profile.html" tabindex="0">Basel Kaffoura</a>
                                </h6>
                                <p>Adobe Instructor</p>
                            </div>
                        </div>
                        <div class="mentor">
                            <div class="mentor__img">
                                <img src="{{asset('frontend/dist/images/instructor/30.jpg')}}"
                                    alt="Mentor image" />
                        ...
                        <div class="mentor">
                            <div class="mentor__img">
                                <img src="{{asset('frontend/dist/images/instructor/040.jpg')}}"
                                    alt="Mentor image" />
                        ...
                        <div class="mentor">
                            <div class="mentor__img">
                                <img src="{{asset('frontend/dist/images/instructor/10.png')}}"
                                    alt="Mentor image" />
                            ...
                            <div class="mentor__title">
                                <h6><a href="instructor-profile.html" tabindex="0">Basel Kaffoura</a></h6>
                                <p>Adobe Instructor</p>
                            </div>
                        </div>
                        <div class="mentor">
                            <div class="mentor__img">
                                <img src="{{asset('frontend/dist/images/instructor/20.png')}}"
                                    alt="Mentor image" />
